...
def generate_psychological_questions():
    ...
    try:
        ...
        try:
            questions_data = safe_json_extract(response_text)
    ...
    while True:
        ...
        if results.detections:
            for detection in results.detections:
                # Bounding box processing with safety
                ...
                if x < x2 and y < y2:
                    ...
                    if face.size > 0:  # ✅ Ensure not empty
                        try:
                            # Preprocess face
                            ...
                            cv2.rectangle(frame, (x, y), (x2, y2), (105, 105, 105), 2)
...
def archer(request):
    return render(request, 'archer.html')
